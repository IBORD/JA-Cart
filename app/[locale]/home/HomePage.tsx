    ...
    <main className="bg-gray-900 text-gray-100 min-h-screen">
      <section className="container mx-auto py-16 px-4 text-center">
        ...
        <p className="text-lg sm:text-xl text-gray-300 mb-8">
          Descubra tendências e se vista com atitude. Sua nova experiência em
          moda começa aqui.
        </p>
        <Link href="/produtos">
      ...
      <section className="container mx-auto py-16 px-4 grid md:grid-cols-2 gap-12">
        <div className="bg-gray-800 p-8 rounded-xl shadow-lg">
          ...
          <p className="text-gray-300 mb-6">
            Inspire-se com looks incríveis, desfiles e vídeos da nossa
            comunidade fashion.
          </p>
          <Link href="/galeria">
        ...
        <div className="bg-gray-800 p-8 rounded-xl shadow-lg">
          ...
          <p className="text-gray-300 mb-6">
            Conheça a história por trás da nossa marca e o que nos move no mundo
            da moda.
          </p>
          <Link href="/sobre">
